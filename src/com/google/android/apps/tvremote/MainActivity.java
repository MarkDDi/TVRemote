...
public class MainActivity extends BaseActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    slidingLayout.addView(
        inflater.inflate(R.layout.subview_playcontrol_tv, null), 0); // 加载上半部分部件
    slidingLayout.addView(
        inflater.inflate(R.layout.subview_touchpad, null), 1);  // 加载右上角触摸鼠标
    ...
    ImageButton shortcutsButton =
        (ImageButton) findViewById(R.id.button_shortcuts);      // 更多设置
