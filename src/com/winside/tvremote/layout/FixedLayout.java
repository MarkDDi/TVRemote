...
package com.winside.tvremote.layout;
...
public final class FixedLayout extends ViewGroup {
  ...
  public static class FixedLayoutParams extends ViewGroup.LayoutParams {
    ...
    public FixedLayoutParams(Context context, AttributeSet attrs) {
      ...
      TypedArray array =
          context.obtainStyledAttributes(attrs, com.winside.tvremote.R.styleable.FixedLayout);
      percent =
          array.getFloat(com.winside.tvremote.R.styleable.FixedLayout_layout_percent, UNSPECIFIED);
      array.recycle();
    }
  }
