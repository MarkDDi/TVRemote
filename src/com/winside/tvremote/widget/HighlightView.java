...
public final class HighlightView extends View {
  ...
  public HighlightView(Context context, AttributeSet attrs, int defStyle) {
    ...
    TypedArray array =
        context.obtainStyledAttributes(attrs, com.winside.tvremote.R.styleable.HighlightView);
    highlightDrawable =
        (NinePatchDrawable) array.getDrawable(com.winside.tvremote.R.styleable.HighlightView_button);
