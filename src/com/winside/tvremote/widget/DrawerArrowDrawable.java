...
public abstract class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        this.mPaint.setColor(context.getResources().getColor(com.winside.tvremote.R.color.ldrawer_color));
        this.mSize = context.getResources().getDimensionPixelSize(com.winside.tvremote.R.dimen.ldrawer_drawableSize);
        this.mBarSize = context.getResources().getDimensionPixelSize(com.winside.tvremote.R.dimen.ldrawer_barSize);
        this.mTopBottomArrowSize = context.getResources().getDimensionPixelSize(com.winside.tvremote.R.dimen.ldrawer_topBottomBarArrowSize);
        this.mBarThickness = context.getResources().getDimensionPixelSize(com.winside.tvremote.R.dimen.ldrawer_thickness);
        this.mBarGap = context.getResources().getDimensionPixelSize(com.winside.tvremote.R.dimen.ldrawer_gapBetweenBars);
        this.mMiddleArrowSize = context.getResources().getDimensionPixelSize(com.winside.tvremote.R.dimen.ldrawer_middleBarArrowSize);
